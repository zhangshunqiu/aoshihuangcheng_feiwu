...
var game;
(function (game) {
    var WingTransformView = (function (_super) {
        __extends(WingTransformView, _super);
        function WingTransformView(skinName) {
            var _this = _super.call(this, "WingTransformSkin") || this;
            _this._backpackModel = game.BackpackModel.getInstance();
            _this.itemType = {};
            _this._eventId = 0;
            return _this;
        }
        WingTransformView.prototype.childrenCreated = function () {
            _super.prototype.childrenCreated.call(this);
            this.initView();
        };
        WingTransformView.prototype.initView = function () {
            var _this = this;
         ...
         * 转换
         */
        WingTransformView.prototype.transform = function () {
            if (!this.currentType) {
         ...
         * 从背包的里把翅膀装备拿出来
         */
        WingTransformView.prototype.getWingEquip = function () {
            if (this.list) {
         ...
         * 选中羽翼装备后的处理函数
         */
        WingTransformView.prototype.itemTap = function (event) {
        ...
        WingTransformView.prototype.otherWingEquip = function (data, pos) {
        ...
        WingTransformView.prototype.transformResult = function (data) {
            if (data.result) {
                this.gp_content.visible = false;
        ...
        * 打开窗口
        */
        WingTransformView.prototype.open = function (openParam) {
         ...
         * 清理
         */
        WingTransformView.prototype.clear = function (data) {
         ...
         * 销毁
         */
        WingTransformView.prototype.destroy = function () {
            _super.prototype.destroy.call(this);
        };
        return WingTransformView;
    }(BaseChildView));
    game.WingTransformView = WingTransformView;
    __reflect(WingTransformView.prototype, "game.WingTransformView");
...
//# sourceMappingURL=WingTransformView.js.map