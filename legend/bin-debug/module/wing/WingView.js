...
//             App.BtnTipManager.addBtnTipItem(ConstBtnTipType.WING_TRAIN, this.btn_develop, 150);
//             App.BtnTipManager.addBtnTipItem(ConstBtnTipType.WING_EQUIP, this.btn_equip, 150);
//         }
//         /**
//          * 红点
//          */
...
//                 this.btn_transform.visible = true;
...
//                 egret.setTimeout(() => { this.developWing() }, this, 100);  //打开羽翼培养界面
//                 this.initStar(0);
//                 this.btn_equip.visible = true;
//                 this.btn_transform.visible = true;
//             } else {
...
//                     this._zhengyuMc.x = 289;
//                     this._zhengyuMc.y = 266;
...
//                     this._rongyuMc.x = 289;
//                     this._rongyuMc.y = 266;
...
//             }
//             App.EventSystem.dispatchEvent(PanelNotify.WING_OPENWIN);
//         }
// 		/**
// 		 * 关闭窗口
// 		 */
...
//             }
//             this.stopAutoAddExp();
//             App.EventSystem.dispatchEvent(PanelNotify.WING_CLOSEWIN);
...
//     }
// } 
//# sourceMappingURL=WingView.js.map