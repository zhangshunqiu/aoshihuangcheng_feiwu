...
var game;
(function (game) {
    var MustDoTitleDetailView = (function (_super) {
        __extends(MustDoTitleDetailView, _super);
        function MustDoTitleDetailView(viewConf) {
            if (viewConf === void 0) { viewConf = null; }
            var _this = _super.call(this, viewConf) || this;
            _this._mustdomodel = game.MustDoModel.getInstance();
            return _this;
        }
        MustDoTitleDetailView.prototype.childrenCreated = function () {
        ...
        /**
                 * 打开窗口
                */
        MustDoTitleDetailView.prototype.openWin = function (openParam) {
            if (openParam === void 0) { openParam = null; }
            _super.prototype.openWin.call(this, openParam);
            var title = App.ConfigManager.getTitleInfoById(this._mustdomodel.selectTitleId);
            var info = App.ConfigManager.getTitleAttByAttId(title.att_id);
            if (this._mustdomodel.selectTitileVo.type == 2) {
                var newDate = new Date(this._mustdomodel.selectTitileVo.time * 1000);
         ...
         * 关闭窗口
         */
        MustDoTitleDetailView.prototype.closeWin = function (callback) {
            _super.prototype.closeWin.call(this, callback);
        };
        /**
         * 清理
         */
        MustDoTitleDetailView.prototype.clear = function (data) {
         ...
         * 销毁
         */
        MustDoTitleDetailView.prototype.destroy = function () {
            _super.prototype.destroy.call(this);
        };
        return MustDoTitleDetailView;
    }(BaseView));
    game.MustDoTitleDetailView = MustDoTitleDetailView;
    __reflect(MustDoTitleDetailView.prototype, "game.MustDoTitleDetailView");
})(game || (game = {}));
//# sourceMappingURL=MustDoTitleDetailView.js.map