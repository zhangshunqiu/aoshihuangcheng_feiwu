...
module game {
    export class BossView extends BaseView {
        ...
        public lb_look_ranking: eui.Label;
        ...
        private _rankUpdateEventId: number = 0;
        ...
        protected childrenCreated() {
            ...
            this.lb_look_ranking.addEventListener(egret.TouchEvent.TOUCH_TAP, () => {
        ...
        public updateRank() {
            //获取关卡排名
            let ranking = (RankGuanqiaModel.getInstance() as RankGuanqiaModel).rankArr;
